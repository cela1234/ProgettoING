...
from form_Menu import DettaglioProdotto, ModificaProdottoMenu, AggiungiProdottoMenu
...
"prodotto selezionato"))
    ...
    def btModificaProdottoClicked(self):
        ...
        if selectedRow == -1:
            ...
            self.fGestioneMenu.setEnabled(False)
            self.formModProdotto = QtWidgets.QDialog()
            self.ui = ModificaProdottoMenu.Ui_Form()
            self.ui.setupUi(self.formModProdotto, self.tableProdotti.item(selectedRow, 0).text())
            self.formModProdotto.exec_()
            self.fGestioneMenu.setEnabled(True)
            self.load_data_tabella()

    def btInserisciProdottoClicked(self):
        self.fGestioneMenu.setEnabled(False)
        self.formAggProdotto = QtWidgets.QDialog()
        self.ui = AggiungiProdottoMenu.Ui_Form()
        self.ui.setupUi(self.formAggProdotto)
        self.formAggProdotto.exec_()
        self.fGestioneMenu.setEnabled(True)
        self.load_data_tabella()
